...
namespace Portal.Services.BookingService
{
    ...
    public interface IBookingService
    {
        ...
        Task<List<Booking>> GetAllBookingAsync(Role permissions);
        ...
        /// <exception cref="BookingUpdateException">Ошибка при обновлении неактуальных броней</exception>
        Task<List<Booking>> GetBookingByUserAsync(Guid userId, Role permissions);
        ...
        /// <exception cref="BookingUpdateException">Ошибка при обновлении неактуальных броней</exception>
        Task<List<Booking>> GetBookingByZoneAsync(Guid zoneId, Role permissions);
        ...
        Task<List<FreeTime>> GetFreeTimeAsync(Guid zoneId, DateOnly date, Role permissions);
        ...
        Task<Booking> GetBookingByIdAsync(Guid bookingId, Role permissions);
        ...
        Task<Guid> AddBookingAsync(Guid userId, Guid zoneId, Guid packageId, DateOnly date, TimeOnly startTime, TimeOnly endTime, Role permissions);
        ...
        Task ChangeBookingStatusAsync(Guid bookingId, BookingStatus status, Role permissions);
        ...
        /// <exception cref="BookingNotFoundException">Бронь не найдена</exception>
        /// <exception cref="BookingUpdateException">При обновлении брони</exception>
        Task UpdateBookingAsync(Booking booking, Role permissions);
        ...
        Task RemoveBookingAsync(Guid bookingId, Role permissions);
        ...
        Task<bool> IsFreeTimeAsync(DateOnly date, TimeOnly startTime, TimeOnly endTime, Role permissions);
    }
}
