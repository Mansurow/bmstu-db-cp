...
public interface IMenuService
{
    ...
    Task<List<Dish>> GetAllDishesAsync(Role permissions);
    ...
    Task<Dish> GetDishByIdAsync(Guid dishId, Role permissions);
    ...
    Task<Guid> AddDishAsync(string name, DishType type, double price, string description, Role permissions);
    ...
    Task UpdateDishAsync(Dish updateDish, Role permissions);
    ...
    Task RemoveDishAsync(Guid dishId, Role permissions);
}
