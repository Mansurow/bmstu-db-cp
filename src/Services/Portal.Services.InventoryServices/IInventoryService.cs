...
public interface IInventoryService
{
    ...
    Task<List<Inventory>> GetAllInventoriesAsync(Role permissions);
    ...
    Task<Inventory> GetInventoryByIdAsync(Guid inventoryId, Role permissions);
    ...
    Task<Guid> AddInventoryAsync(Guid zoneId, string name, DateOnly yearOfProduction, string description, Role permissions);
    ...
    Task UpdateInventoryAsync(Inventory inventory, Role permissions);
    ...
    Task RemoveInventoryAsync(Guid inventoryId, Role permissions);
}