...
public interface IPackageService
{
    ...
    Task<List<Package>> GetPackagesAsync(Role permissions);
    ...
    Task<Package> GetPackageById(Guid packageId, Role permissions);
    ...
    Task UpdatePackageAsync(Package package, Role permissions);
    ...
    Task RemovePackageAsync(Guid packageId, Role permissions);
}