...
public class PortalAccessObject: IDisposable
{
    ...
    public async Task InsertManyDishesAsync(List<Dish> menu)
    {
        ...
        {
            await MenuRepository.InsertDishAsync(dish, Role.Administrator);
        }
    }

    public void InitRepo(InMemoryDbContextFactory contextFactory)
    {
    ...
    public void InitRepo(NpgsqlDbContextFactory contextFactory)
    {
        MenuRepository = new MenuRepository(contextFactory);
        UserRepository = new UserRepository(contextFactory);
        FeedbackRepository = new FeedbackRepository(contextFactory);
    ...
    public async Task InsertManyUsersAsync(List<User> users)
    {
        ...
        {
            await UserRepository.InsertUserAsync(user, Role.Administrator);
        }
    }
    ...
    public async Task InsertManyZonesAsync(List<Zone> zones)
    {
        ...
        {
            await ZoneRepository.InsertZoneAsync(zone, Role.Administrator);
        }
    }
    ...
    public async Task InsertManyPackagesAsync(List<Package> packages)
    {
        ...
        {
            await PackageRepository.InsertPackageAsync(package, Role.Administrator);
        }
    }
    ...
    public async Task InsertManyBookingsAsync(List<Booking> bookings)
    {
        ...
        {
            await BookingRepository.InsertBookingAsync(booking, Role.Administrator);
        }
    }
