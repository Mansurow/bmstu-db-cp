...
public class BookingServiceIntegrationalTests
{
    ...
    public async Task GetBookingsByZoneOkTest()
    {
        ...
        // Act
        var actualBookings = await _bookingService.GetBookingByZoneAsync(expectedZone.Id, Permissions);
        var actualCount = actualBookings.Count;
    ...
    public async Task GetBookingNotFoundTest()
    {
        ...
        // Act
        Task<Booking> Action() => _bookingService.GetBookingByIdAsync(expectedBookingId, Permissions);
    ...
    public async Task GetFreeTimeOkTest()
    {
        ...
        // Act
        var actualListFreeTime = await _bookingService.GetFreeTimeAsync(zone.Id, 
    ...
    public async Task RemoveBookingNotFoundTest()
    {
        ...
        // Act
        Task Action() => _bookingService.RemoveBookingAsync(Guid.NewGuid(), Permissions);
