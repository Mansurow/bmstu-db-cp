...
public class MenuServiceIntegrationTests: IDisposable
{
    ...
    public async Task GetDishEmptyNotFoundTest()
    {
        ...
        // Act
        Task<Dish> Action() => _menuService.GetDishByIdAsync(dishId, Permissions);
    ...
    public async Task AddDishOkTest()
    {
        ...
        var actualDishId = await _menuService.AddDishAsync(expectedDish.Name, expectedDish.Type, 
            expectedDish.Price, expectedDish.Description, Permissions);
    ...
    public async Task UpdateDishOkTest()
    {
        ...
        // Act
        await _menuService.UpdateDishAsync(updateDish, Permissions);
    ...
    public async Task UpdateDishNotFoundTest()
    {
        ...
        // Act
        Task Action() => _menuService.UpdateDishAsync(updateDish, Permissions);
    ...
    public async Task RemoveDishOkTest()
    {
        ...
        // Act
        await _menuService.RemoveDishAsync(removeDish.Id, Permissions);
    ...
    public async Task RemoveDishNotFoundTest()
    {
        ...
        // Act
        Task Action() => _menuService.RemoveDishAsync(removeDishId, Permissions);
