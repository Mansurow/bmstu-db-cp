...
public class BookingServiceUnitTests
{
    ...
    public async Task GetAllBookingsTest()
    {
        ...
        _mockBookingRepository.Setup(s => s.GetAllBookingAsync(It.IsAny<Role>()))
            .ReturnsAsync(bookings);
    
        _mockBookingRepository.Setup(s => s.UpdateNoActualBookingAsync(It.IsAny<Guid>(), It.IsAny<Role>()))
        ...
        // Act
        var actualBookings = await _bookingService.GetAllBookingAsync(Role.Administrator);
    ...
    public async Task GetAllBookingsEmptyTest()
    {
        ...
        // Act
        var actualBookings = await _bookingService.GetAllBookingAsync(Permissions);
    ...
    public async Task GetBookingByUserTest()
    {
        ...
        _mockBookingRepository.Setup(s => s.GetBookingByUserAsync(It.IsAny<Guid>(), It.IsAny<Role>()))
            .ReturnsAsync((Guid userId, Role p) => bookings.FindAll(e => e.UserId == userId));
        ...
        // Act
        var actualBookings = await _bookingService.GetBookingByUserAsync(expectedUser.Id, Permissions);
    ...
    public async Task GetBookingByIdTest()
    {
        ...
        _mockBookingRepository.Setup(s => s.GetBookingByIdAsync(It.IsAny<Guid>(), It.IsAny<Role>()))
            .ReturnsAsync((Guid id, Role p) => bookings.First(b => b.Id == id));
        
        // Act
        var actualBooking = await _bookingService.GetBookingByIdAsync(expectedBooking.Id, Permissions);
    ...
    public async Task GetBookingByIdNotFoundTest()
    {
        ...
        // Act
        Task<Booking> Action() => _bookingService.GetBookingByIdAsync(bookingId, Permissions);
    ...
    public async Task CreateBookingTest()
    {
        ...
        _mockBookingRepository.Setup(s => s.GetBookingByUserAndZoneAsync(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<Role>()))
            .ReturnsAsync((Guid userId, Guid zoneId, Role p) =>
                bookings.FindAll(b => b.UserId == userId && b.ZoneId == zoneId));
        
        _mockBookingRepository.Setup(s => s.InsertBookingAsync(It.IsAny<Booking>(), It.IsAny<Role>()))
            .Callback((Booking b, Role p) => bookings.Add(b));
        ...
        var expectedId = await _bookingService.AddBookingAsync(expectedBooking.UserId, expectedBooking.ZoneId, expectedBooking.PackageId,
            expectedBooking.Date, expectedBooking.StartTime, expectedBooking.EndTime, Role.Administrator);
    ...
    public async Task CreateBookingReversedTimeTest(string startTime, string endTime)
    {
        ...
        // Act
        async Task<Guid> Action() => await _bookingService.AddBookingAsync(expectedBooking.UserId, expectedBooking.ZoneId, 
            expectedBooking.PackageId, expectedBooking.Date, expectedBooking.StartTime, expectedBooking.EndTime, Permissions);
        var actualCount = bookings.Count;
    ...
    public async Task CreateBookingReversedDateTest()
    {
        ...
        // Act
        Task<Guid> Action() => _bookingService.AddBookingAsync(expectedBooking.UserId, 
            expectedBooking.ZoneId, expectedBooking.PackageId, expectedBooking.Date, 
            expectedBooking.StartTime, expectedBooking.EndTime, Permissions);
        var actualCount = bookings.Count;
    ...
    public async Task CreateBookingZoneNotFoundTest()
    {
        ...
        // Act
        Task<Guid> Action() => _bookingService.AddBookingAsync(expectedBooking.UserId, expectedBooking.ZoneId, 
            expectedBooking.PackageId, expectedBooking.Date, expectedBooking.StartTime, expectedBooking.EndTime, Permissions);
    ...
    public async Task IsFreeTimeEmptyTest(string date, string startTime, string endTime, bool expectedResult)
     {
         ...
         var actualResult = await _bookingService.IsFreeTimeAsync(DateOnly.Parse(date), 
             TimeOnly.Parse(startTime),
             TimeOnly.Parse(endTime), Permissions);
    ...
    public async Task GetFreeTimeTest1()
    {
        ...
        _mockBookingRepository.Setup(s => s.GetBookingByZoneAsync(It.IsAny<Guid>(), It.IsAny<Role>()))
            .ReturnsAsync(bookings);
        ...
        // Act
        var actualFreeTime = await _bookingService.GetFreeTimeAsync(zoneId, day, Permissions);
    ...
    public async Task GetFreeTimeTest2()
    {
     ...
     public async Task ChangeBookingStatusTest(BookingStatus oldStatus, BookingStatus newStatus)
     {
         ...
         _mockBookingRepository.Setup(s => s.UpdateBookingAsync(It.IsAny<Booking>(), It.IsAny<Role>()))
             .Callback((Booking b, Role p) =>
             {
         ...
         await _bookingService.ChangeBookingStatusAsync(bookingId, newStatus, Permissions);
     ...
     public async Task ChangeBookingStatusNotSuitableTest(BookingStatus oldStatus, BookingStatus newStatus)
     {
         ...
         // Act
         var bookingId = bookings.FirstOrDefault(b => b.Status == oldStatus)!.Id;
         Task Action() => _bookingService.ChangeBookingStatusAsync(bookingId, newStatus, Permissions);
     ...
     public async Task UpdateBookingTest()
     {
         ...
         // Act
         await _bookingService.UpdateBookingAsync(expectedBooking, Permissions);
     ...
     public async Task UpdateBookingNotFoundTest()
     {
         ...
         // Act
         Task Action() => _bookingService.UpdateBookingAsync(expectedBooking, Permissions);
     ...
     public async Task UpdateBookingExceedsLimitTest()
     {
         ...
         // Act
         async Task Action() => await _bookingService.UpdateBookingAsync(expectedBooking, Permissions);
    ...
    public async void RemoveBookingTest()
    {
        ...
        _mockBookingRepository.Setup(s => s.DeleteBookingAsync(It.IsAny<Guid>(), It.IsAny<Role>()))
                              .Callback((Guid id, Role p) =>
                              {
        ...
        // Act
        await _bookingService.RemoveBookingAsync(booking.Id, Permissions);
        var actualCount = bookings.Count;
    ...
    public async void RemoveBookingNotFoundTest()
    {
        ...
        // Act
        async Task Action() => await _bookingService.RemoveBookingAsync(bookingId, Permissions);
        var actualCount = bookings.Count;
