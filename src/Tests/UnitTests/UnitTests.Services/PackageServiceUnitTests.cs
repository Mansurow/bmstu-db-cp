...
public class PackageServiceUnitTests
{
    ...
    public async Task GetAllPackagesTest()
    {
        ...
        _mockPackageRepository.Setup(s => s.GetAllPackagesAsync(It.IsAny<Role>()))
            .ReturnsAsync(packages);

        // Act
        var actualPackages = await _packageService.GetPackagesAsync(Permissions);
    ...
    public async Task GetPackageByIdTest()
    {
        ...
        // Act
        var actualPackage = await _packageService.GetPackageById(expectedPackage.Id, Permissions);
    ...
    public async Task GetPackageByIdNotFoundTest()
    {
        ...
        // Act
        Task<Package> Action() => _packageService.GetPackageById(expectedPackageId, Permissions);
    ...
    public async Task AddPackageTest()
    {
        ...
        _mockPackageRepository.Setup(s => s.InsertPackageAsync(It.IsAny<Package>(), It.IsAny<Role>()))
            .Callback((Package package, Role p) => packages.Add(package));

        // Act
        var actualPackageId = await _packageService.AddPackageAsync(expectedPackage.Name, expectedPackage.Type, 
            expectedPackage.Price, expectedPackage.RentalTime, expectedPackage.Description, new List<Guid>(), Permissions);
    ...
    public async Task UpdatePackageTest()
    {
        ...
        _mockPackageRepository.Setup(s => s.GetPackageByIdAsync(It.IsAny<Guid>(), It.IsAny<Role>()))
            .ReturnsAsync((Guid packageId, Role p) => packages.First(e => e.Id == packageId));
        
        _mockPackageRepository.Setup(s => s.UpdatePackageAsync(It.IsAny<Package>(), It.IsAny<Role>()))
            .Callback((Package p, Role r) =>
            {
        ...
        // Act
        await _packageService.UpdatePackageAsync(expectedPackage, Permissions);
    ...
    public async Task UpdatePackageNotFoundTest()
    {
        ...
        // Act
        Task Action() => _packageService.UpdatePackageAsync(expectedPackage, Permissions);
        // var actualPackage = packages.First();
    ...
    public async Task RemovePackageTest()
    {
        ...
        _mockPackageRepository.Setup(s => s.DeletePackageAsync(It.IsAny<Guid>(), It.IsAny<Role>()))
        ...
        // Act
        await _packageService.RemovePackageAsync(expectedPackageId, Permissions);
    ...
    public async Task RemovePackageNotFoundTest()
    {
        ...
        // Act
        Task Action() => _packageService.RemovePackageAsync(expectedPackageId, Permissions);
        var actualCount = packages.Count;
