...
public static class ServiceCollectionExtension
{
    ...
    public static void AddPortalDbContextByRoles(this IServiceCollection services, IConfiguration config)
    {
        services
            .AddDbContext<AdminDbContext>(
            opt => opt.UseNpgsql(config.GetConnectionString("AdminConnection")),
            ServiceLifetime.Transient,
            ServiceLifetime.Transient)
            .AddDbContext<UserDbContext>(
            opt => opt.UseNpgsql(config.GetConnectionString("UserConnection")),
            ServiceLifetime.Transient,
            ServiceLifetime.Transient)
            .AddDbContext<GuestDbContext>(
            opt => opt.UseNpgsql(config.GetConnectionString("GuestConnection")),
            ServiceLifetime.Transient,
            ServiceLifetime.Transient);
